...
{
  "Emin": -400.0,   (Maximum electric field range in kV/cm)
  "Emax": 400.0,    (Minimum electric field range in kV/cm)
...
Step 3: 
********************************START**********************************************
quantum_v34.py :- This code evolves the density matrix and analytical wavefunction of a ferroelectric/antiferroelectric system under an applied electric field (AC or DC).
...
"nsteps": 75000,               (Number of simulation steps)
"delta_t": 0.01,               (Intergration time step in fs)
...
"delta_P": 0.00,               (Initial condition, width of the packet in polarization units C/m^2)
"n_out": 500,                  (How often to plot probability densities)
"relaxation_model": "DMB",     (Different relaxation models, options are DMB or LO)
"thermal_weight": "boltzmann", (Different thermostate, options are "boltzmann" and "zero_weight" for DMB and only "boltzmann" LO)
"gamma_rescale": 4.555928e-02  (Rescalies damping parameter can be obtaned from analyze_v3.py)
